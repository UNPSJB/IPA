...
urlpatterns = [
	...
	url(r'^modificar/(?P<pk>\d+)/$', ModificarPermiso.as_view(), name='modificar'),
	...
	url(r'^detalle/(?P<pks>\d+)/documentos/(?P<pkd>\d+)/rechazar/$', rechazar_documento_solicitud, name='rechazarDocumentoSolicitud'),
