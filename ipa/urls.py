...
urlpatterns = [
    ...
    url(r'^solicitantes/', include('apps.personas.urls.solicitantes')),
    url(r'^choferes/', include('apps.personas.urls.choferes')),
    ...
    url(r'^liquidadores/', include('apps.personas.urls.liquidadores')),
    url(r'^sumariantes/', include('apps.personas.urls.sumariantes')),
    url(r'^jefesdepartamento/', include('apps.personas.urls.jefesDepartamento')),
